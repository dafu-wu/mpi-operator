...
import (
	...
	mpijobv2 "github.com/dafu-wu/mpi-operator/pkg/apis/kubeflow/v2beta1"
)
...
func swaggify(name string) string {
	name = strings.Replace(name, "github.com/dafu-wu/mpi-operator/pkg/apis/kubeflow/", "", -1)
	name = strings.Replace(name, "github.com/dafu-wu/common/pkg/apis/common/", "", -1)
